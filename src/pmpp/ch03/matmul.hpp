...
cudaError_t matmul_cell_resources(const lg::matmul::GemmShape&,
                                  lg::benchmark::KernelResources& resources);
cudaError_t matmul_row_resources(const lg::matmul::GemmShape&,
                                 lg::benchmark::KernelResources& resources);
cudaError_t matmul_col_resources(const lg::matmul::GemmShape&,
                                 lg::benchmark::KernelResources& resources);
